      ...
      <div class="max-w-7xl mx-auto">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-slate-600 mt-1">Manage your inventory products</p>
          </div>
